...
const s = StyleSheet.create({
  ...
  cardSelected:     { borderColor: COLORS.brand, backgroundColor: COLORS.card2 },
  colorBar:         { width: 5 },
  ...
  typeCardSelected: { borderColor: COLORS.brand, backgroundColor: COLORS.card2 },
  ...
  tableChipSelected:{ backgroundColor: COLORS.card2, borderColor: COLORS.brand },
  tableChipText:    { color: COLORS.subtext, fontSize: 14, fontWeight: '600' },
  tableChipTextSelected: { color: COLORS.brand },
});
