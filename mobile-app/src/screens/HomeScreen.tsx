...
//
// UAT-W2A (2026-08-03): header gained a WeatherBadge (Open-Meteo, fail-silent)
// next to the wordmark, and a real "Recent galleries" shelf (shared
// RecentGalleries component, sourced from getApprovedGalleries) now sits
// below Deals & Specials — the mock-only gap noted above is closed.
//
  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme.bg }}>
      ...
      >
        ...
        {/* Recent galleries — most recent galleries across the app */}
